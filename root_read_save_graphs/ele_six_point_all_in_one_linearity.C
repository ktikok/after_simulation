    ...
    for(int j=0; j<1; i++){
        ...
        for(int i=2; i<5; i++){    
            if(j==0){
                ...
                string canvasTitle= "Energy_Resolution";
            }
            else{
                string canvasTitle= "Energy_Linearity";
            }

            if(i==2){
                // TCanvas *myc = new TCanvas("myc",  "Energy Resolution");
                string canvasName= "myc_c";
            }
            else if(i==3){
                // TCanvas *myc = new TCanvas("myc",  "Energy Resolution");
                string canvasName= "myc_s";
            }
            else{
                string canvasName= "myc_sum";
                
            }

            canvasName = canvasName + canvasTitle
            const char*  canvasName1= canvasName.c_str();

            TCanvas *myc = new TCanvas(canvasName1,  canvasTitle);
